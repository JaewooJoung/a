...
# Install Korean fonts and input method (kime)
pacman -S --noconfirm \
...
# Configure kime
mkdir -p /home/${USERNAME}/.config/kime
cat > /home/${USERNAME}/.config/kime/config.yaml <<EOF
layout:
  hangul: Han2
  latin: Qwerty
global_shortcut:
...
echo "1. Korean input can be toggled with Alt+R"
echo "2. Run 'kime-config' to configure input method"
echo "3. Use 'kime --debug' if you need to troubleshoot"
