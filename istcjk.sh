...
echo "2) Asia/Seoul (Korea)"
echo "3) Asia/Tokyo (Japan)"
read -p "Enter your choice (1-3): " tz_choice
...
# CJK 폰트 및 입력기 설치 (Chinese, Japanese, Korean)
pacman -S --noconfirm \
    ...
    ttf-baekmuk powerline-fonts nerd-fonts ttf-lato \
    fcitx5 fcitx5-configtool fcitx5-gtk fcitx5-qt \
    fcitx5-chinese-addons fcitx5-japanese fcitx5-hangul \
    libhangul gimp gimp-help-ko \
    libreoffice-fresh libreoffice-fresh-ko \
    firefox-i18n-ko thunderbird-i18n-ko thunderbird-i18n-ja thunderbird-i18n-zh-cn thunderbird-i18n-zh-tw

# 프로그래밍 언어 및 개발 도구 설치
pacman -S --noconfirm \
    firefox thunderbird thunderbird-i18n-ko thunderbird-i18n-ja thunderbird-i18n-zh-cn thunderbird-i18n-zh-tw \
...
# Fcitx5 입력기 설정
cat > /home/${USERNAME}/.config/fcitx5/config <<EOF
[Hotkey]
TriggerKeys=Control+Space
SwitchPreedit=Control+Alt+P
